...
import numpy as np
img1 = image.load_img('validation/Human/Human (2)0.png', target_size=(640,480))
...
img1 = image.load_img('validation/Human/Human (23)0.png')
plt.imshow(img1);
#preprocess image
img1 = image.load_img('validation/Human/Human (23)0.png', target_size=(640,480))
img = image.img_to_array(img1)
img = img/255
img = np.expand_dims(img, axis=0)
